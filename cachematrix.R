## We have 2 functions here, The 1st creates a special matrix which is a list
## while the 2nd function calculates the inverse of the aforementioned matrix
## after first evaluating whether the inverse of the matrix has previously been
## computed. If so, it takes the inverse from the cache thereby saving a lot of
